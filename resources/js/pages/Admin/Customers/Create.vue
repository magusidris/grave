            ...
            <div class="flex h-full flex-col space-y-6">
                ...
                <form class="space-y-7" @submit.prevent="onSubmit">
                    ...
                    <div class="mt-4 flex items-center gap-2">
                        ...
                        <Button as-child><Link href="/admin/management/customers">Batal</Link></Button>
                    </div>
                </form>
            </div>
        </div>
...
const onSubmit = () => {
    form.post('/admin/management/customers', {
...
const info = { title: 'Create Customer', description: 'Create a new customer' };
