            ...
            <div class="flex h-full flex-col space-y-6">
                ...
                <div>
                    <form @submit.prevent="handleSearch">
                        <div class="mb-4 flex w-full items-center">
                            <Button class="h-10 w-27 rounded-r-none bg-teal-600 uppercase hover:bg-teal-700" as-child
                                ><Link href="/admin/customers/create"><Icon code="fa6-solid:plus" /> New</Link>
                            </Button>
                    ...
                    <Table class="table-fixed">
                        ...
                        <TableBody>
                            <TableRow v-for="(value, id) in customers.data" :key="id">
                                ...
                                <TableCell class="content-start text-center">
                                    <Button class="mr-2 bg-green-600 hover:bg-green-700" size="sm" as-child
                                        ><Link :href="`/admin/customers/${value.id}/edit`"> <Icon code="fa6-solid:pencil" /> Edit </Link></Button
                                    >
                                    <AlertDialog
...
const info = { title: 'Customer Management', description: 'Manage your Customers' };
...
const handleConfirmDelete = (customer: Identity) => {
